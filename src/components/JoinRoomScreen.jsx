  ...
  return (
    <main className="h-screen w-full flex justify-center items-center overflow-hidden bg-white">
      <div className="w-full max-w-md h-full flex flex-col px-5 py-6">
        ...
        <button
          onClick={onSubmit}
          className="mt-6 h-12 rounded-xl bg-echo text-sm font-bold uppercase tracking-wide text-white active:scale-98 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Gabung Room
        </button>
      </div>
